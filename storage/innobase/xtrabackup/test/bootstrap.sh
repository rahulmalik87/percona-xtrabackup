...
case "$1" in
    ...
    xtradb80)
        url="https://www.percona.com/downloads/Percona-Server-8.0/Percona-Server-8.0.19-10/binary/tarball"
        tarball="Percona-Server-8.0.19-10-Linux.${arch}.glibc2.12.tar.gz"
        ;;
